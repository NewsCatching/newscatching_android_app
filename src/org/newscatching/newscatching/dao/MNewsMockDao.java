...
public class MNewsMockDao extends BaseNewsDao {
	...
	public ReturnMessage<List<HotNews>> getHotNews() {
		...
		for (int i = 0; i < 5; ++i) {
			list.add(new HotNews("" + i, "test " + i,
					"https://fbcdn-profile-a.akamaihd.net/hprofile-ak-prn1/211229_1403951219_1146935976_q.jpg"));
		}
		list.get(3).setImageUrl(null);
		list.add(new HotNews("" + 5, "test 5",
				"https://fbcdn-profile-a.akamaihd.net/hprofile-ak-prn2/s32x32/203402_1521110015_1215854080_q.jpg"));
	...
	public ReturnMessage<NewsDetails> getNews(String newsID) {
		...
		detail.setNews(n);
		return new ReturnMessage<NewsDetails>(true, 0, "", detail);
	}
